...
app.get('/searchPlace/:city/:state/:country/:travelDate', async (req, res) => {
    ...
    // res.send({daysBeforeTrip: 2, celcius: 33, farenheight: 91, webformatURL: 'https://pixabay.com/get/g66ee5ec4fe74c8fc409ddf452…dc78a0a01d92ed5ffa1d24eb1d404763a88cc8cd6_640.jpg'}) 
})